...
export enum ParagraphStyle {
    p1 = 'leading-[150%] text-mobile-p1 sm:text-tablet-p1 lg:text-desktop-p1',
    p2 = 'leading-[150%] text-mobile-p2 sm:text-tablet-p2 lg:text-desktop-p2',
    p3 = 'leading-[150%] text-mobile-p3 sm:text-tablet-p3 lg:text-desktop-p3',
}
